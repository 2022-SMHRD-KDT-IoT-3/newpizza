    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
            <li><a class="dropdown-item" href="MemberMonitoring.jsp">내 정보 수정</a></li>
...
<form>
  <h1 class="text-center">창고 정보 수정</h1>
    
  <div class="form-floating mb-3 mx-auto w-25" style="margin-top:50px">
    <input type="text" class="form-control" name="mem_id" placeholder="회원 아이디 <%= mem_id %>">
    <label for="exampleInputPassword1" class="form-label">회원 아이디 : <%= mem_id %></label>
    </div>
  <div class="form-floating mb-3 mx-auto w-25">
    <input type="text" class="form-control" name="w_addr" placeholder="창고 주소">
    <label for="exampleInputPassword1" class="form-label">창고 주소</label>
  </div>
...
// 정보 변경 시작
	$('#update').on('click', function() {
		...
		let w_addr = $('input[name=w_addr]').val();
		
		console.log(mem_id);
		console.log(w_addr);
		
		$.ajax({
		url : 'WarehouseUpdateServiceCon.do',
		type : 'post',
		data : {
		mem_id : mem_id,
		w_addr : w_addr,
