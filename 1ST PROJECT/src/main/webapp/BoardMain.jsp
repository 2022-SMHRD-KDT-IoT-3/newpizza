...
<link rel="stylesheet" href="assets1/sass/layout/btn.scss" />
<link
...
<!-- 비로그인 상단바 끝 -->
	...
	<div id="board" class="container">
		...
		<a href="DeleteServiceCon?QNA_SEQ=QNA_SEQ" class="btn btn-outline-secondary"> 삭제하러가기</a> <a
			href="BoardWrite.jsp" class="btn btn-default">
			<button  class="btn btn-outline-secondary"id="write" >글쓰기</button>
		</a>
