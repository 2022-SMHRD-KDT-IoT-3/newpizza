	...
	<table class="table table-hover">
		...
		try {
			...
			for(int i = 1; rs.next(); i++) {
				...
				String st_value = rs.getString(5);
				String device_inst_date = rs.getString(6);
					...
					out.print("<td><a href='AdminSensorUpdate.jsp?sensor_seq="+sensor_seq+"sensor_type="+sensor_type+"sensor_unit="+sensor_unit+"st_value="+st_value+"device_inst_date="+device_inst_date+"'>센서 정보 수정</a></td>");
...
<!-- 푸터 시작 -->
<footer class="bg-dark text-white pt-5 pb-4 fixed-bottom text-start" style="height:144px">
