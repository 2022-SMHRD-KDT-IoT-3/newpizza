...
<!-- 본문 시작  -->
	...
	<table class="table table-hover">
		...
		<tr>
			<td>1</td>
			<td>test</td>
			<td>광주광역시 서구 쌍촌동 1020번지</td>
			<td>2022-03-30 17:00:00</td>
			<td><a href="AdminSensorSelect.jsp">센서 정보 확인</a></td>
			<td><a href="#">창고 정보 수정</a></td>
			<td><a href="#">창고 정보 삭제</a></td>
		</tr>
		
		<tr>
			<td>2</td>
			<td>test</td>
			<td>광주광역시 동구 사직동 65번지</td>
			<td>2022-04-01 14:00:00</td>
			<td><a href="#">센서 정보 확인</a></td>
			<td><a href="#">창고 정보 수정</a></td>
			<td><a href="#">창고 정보 삭제</a></td>
		</tr>
